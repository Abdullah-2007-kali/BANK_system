    ...
    def account_Tayp(self, account_Tayp):
        if account_Tayp == "2":
            while True:
                ...
                mount = int(input("enter miunt:"))
                interest = float(input("enter interest: "))
                cheching_account = savingsaccount.SavingsAccount(account_number, mount, interest)
                bank_1.add_account(cheching_account)
                print("exit=1 | loop=2")
